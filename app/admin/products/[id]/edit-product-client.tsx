...
export default function EditProductClient({ product: initialProduct, categories }: EditProductClientProps) {
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(initialProduct.images);
  const [uploadMethod, setUploadMethod] = useState<'url' | 'file'>(initialProduct.images ? 'url' : 'file');
  ...
  const [formData, setFormData] = useState({
    ...
    applications: initialProduct.applications || '',
